...
public class GuiManager {
   ...
   private void readSettings() {
      try (FileReader reader = new FileReader(this.file)) {
         ...
         String categoryName = props.getProperty("category", Category.Visuals.name());
         if ("Utils".equals(categoryName)) {
            categoryName = Category.Visuals.name();
         }
         this.currentCategory = Category.valueOf(categoryName);

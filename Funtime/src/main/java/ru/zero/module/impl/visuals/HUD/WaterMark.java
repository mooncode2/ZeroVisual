...
public class WaterMark {
   ...
   public static void waterMark(Renderer2D r2) {
      ...
      float zeroW = r2.measureText(FontRegistry.INTER_SEMIBOLD, "Zero", 30.0F).width;
      r2.text(
            FontRegistry.INTER_MEDIUM,
            x + 42.0F + zeroW + 4.0F,
            y + 25.5F,
            14.0F,
            ClientEdition.getDisplayName(),
            Renderer2D.ColorUtil.replAlpha(Renderer2D.ColorUtil.getMainColor(1, 1), 200));

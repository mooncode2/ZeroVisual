...
import ru.zero.module.impl.visuals.TotemTracker;
...
import ru.zero.module.impl.funtime.AutoEat;
import ru.zero.module.impl.funtime.AutoInvisibility;
import ru.zero.module.impl.funtime.AutoResell;
...
import ru.zero.module.impl.utils.NoFriendDamage;
...
public class Manager {
   ...
   public Manager() {
      ...
      this.module.add(new BlockHiliter());
      ...
      this.module.add(new TotemTracker());

...
public class AutoInvisibility extends Module {
   /** Пауза после успешного питья, если эффект ещё не пришёл с сервера. */
   ...
   public void onTick(ClientTickEvent event) {
      ...
      int slot = FunTimeUtil.findInvisibilityHotbarSlot();
      if (slot == -1) {
         FunTimeUtil.failAndDisable(this, "Невидимость не найдена в хотбаре");
         return;
      }

...
public class GuiRenderMain extends GuiScreen {
   ...
   public static void renderMain(Renderer2D renderer2D, MatrixStack pose, int mouseX, int mouseY, float mainAlpha) {
      ...
      for (Module module : filteredModules) {
       ...
       float contentHeight = totalHeight + 4.34F;
         ...
         if (index % 2 == 0) {
            ...
            if (!(settingsAnimx > 0.0F) && !(settingsAlphaAnimx > 0.0F)) {
               if (ru.zero.util.render.glass.LiquidGlassRenderer.isEnabled()) {
                  ru.zero.util.render.glass.LiquidGlassRenderer.drawGlassPanel(renderer2D, GuiScreen.x + 238.35F, GuiScreen.y + 43.365F + currentDownY, 121.47F, 21.325F, 6.5F, outlineColor, backGroundThreeColor);
               } else {
               ...
               if (ru.zero.util.render.glass.LiquidGlassRenderer.isEnabled()) {
                  ru.zero.util.render.glass.LiquidGlassRenderer.drawGlassPanel(renderer2D, GuiScreen.x + 238.35F, GuiScreen.y + 43.365F + currentDownY, 121.47F, 21.325F + settingsHeightx, 6.5F, outlineColor, backGroundThreeColor);
               } else {
            ...
            if (!(settingsAnimxx > 0.0F) && !(settingsAlphaAnimxx > 0.0F)) {
               if (ru.zero.util.render.glass.LiquidGlassRenderer.isEnabled()) {
                  ru.zero.util.render.glass.LiquidGlassRenderer.drawGlassPanel(renderer2D, GuiScreen.x + 111.885F, GuiScreen.y + 43.365F + currentDownYx, 121.47F, 21.325F, 6.5F, outlineColor, backGroundThreeColor);
               } else {
               ...
               if (ru.zero.util.render.glass.LiquidGlassRenderer.isEnabled()) {
                  ru.zero.util.render.glass.LiquidGlassRenderer.drawGlassPanel(renderer2D, GuiScreen.x + 111.885F, GuiScreen.y + 43.365F + currentDownYx, 121.47F, 21.325F + settingsHeightxx, 6.5F, outlineColor, backGroundThreeColor);
               } else {

...
public class GuiRenderUpPanel extends GuiScreen {
   public static void renderUpPanel(Renderer2D renderer2D, MatrixStack pose, float mainAlpha) {
      ...
      if (ru.zero.util.render.glass.LiquidGlassRenderer.isEnabled()) {
         ru.zero.util.render.glass.LiquidGlassRenderer.drawGlassPanel(renderer2D, GuiScreen.x + 111.885F, GuiScreen.y + 6.185F, 124.04F, 21.325F, 5.5F, outlineColor, backGroundThreeColor, mainAlpha);
      } else {
      ...
      if (ru.zero.util.render.glass.LiquidGlassRenderer.isEnabled()) {
         ru.zero.util.render.glass.LiquidGlassRenderer.drawGlassPanel(renderer2D, GuiScreen.x + 312.23F, GuiScreen.y + 6.185F, 21.325F, 21.325F, 5.5F, outlineColor, backGroundThreeColor, mainAlpha);
      } else {
      ...
      if (ru.zero.util.render.glass.LiquidGlassRenderer.isEnabled()) {
         ru.zero.util.render.glass.LiquidGlassRenderer.drawGlassPanel(renderer2D, GuiScreen.x + 338.555F, GuiScreen.y + 6.185F, 21.325F, 21.325F, 5.5F, outlineColor, backGroundThreeColor, mainAlpha);
      } else {
    ...
    private static void renderClientSettingsPopup(Renderer2D renderer2D, float mainAlpha) {
       ...
       int textColor = Renderer2D.ColorUtil.replAlpha(Renderer2D.ColorUtil.getTextColor(1, 1), (int)(255.0F * mainAlpha));
       int bgAlphaColor = Renderer2D.ColorUtil.replAlpha(Renderer2D.ColorUtil.getMainColor(1, 1), (int)(15.3F * mainAlpha));

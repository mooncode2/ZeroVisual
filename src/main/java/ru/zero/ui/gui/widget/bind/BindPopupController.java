package ru.zero.ui.gui.widget.bind;
...
import ru.zero.Zero;
import ru.zero.event.input.MouseUpdateEvent;
...
import ru.zero.ui.gui.widget.bind.editor.BindPopupSettingEditor;
import ru.zero.ui.gui.widget.bind.editor.BindPopupSliderEditor;
import ru.zero.ui.gui.widget.bind.editor.BindPopupSwitchEditor;
import ru.zero.ui.gui.widget.popup.PopupPositioner;
import ru.zero.ui.gui.widget.settings.HSBColor;
...
public final class BindPopupController {
   ...
   private static void setSettingValue(Setting setting, Object value) {
      ...
      if (changed && Zero.get != null && Zero.get.configManager != null) {

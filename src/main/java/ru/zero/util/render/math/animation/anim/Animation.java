package ru.zero.util.render.math.animation.anim;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import ru.zero.util.render.math.animation.anim.bezier.Bezier;
import ru.zero.util.render.math.animation.anim.bezier.list.CubicBezier;
import ru.zero.util.render.math.animation.anim.util.Easing;

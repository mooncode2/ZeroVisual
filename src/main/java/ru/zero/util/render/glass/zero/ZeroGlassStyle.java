...
public final class ZeroGlassStyle {
   ...
   public static ZeroGlassStyle create() {
      return new ZeroGlassStyle();
   }

   public ZeroGlassStyle tint(int color, float alpha) {
      this.tintColor = color;
      this.tintAlpha = Math.max(0.0F, Math.min(1.0F, alpha));
      return this;
   }

   public ZeroGlassStyle smoothing(float factor) {
      this.smoothing = factor;
      return this;
   }

   public ZeroGlassStyle blurRadius(int radius) {
      this.blurRadius = Math.max(0, radius);
      return this;
   }

   public ZeroGlassStyle opacity(float value) {
   ...
   public ZeroGlassStyle refFactor(float factor) {
      this.refFactor = Math.max(1.0F, factor);
      return this;
   }

   public ZeroGlassStyle refThickness(float thickness) {
      this.refThickness = Math.max(0.0F, thickness);
      return this;
   }

   public ZeroGlassStyle refDispersion(float dispersion) {
      this.refDispersion = Math.max(0.0F, dispersion);
      return this;
   }

   public ZeroGlassStyle refFresnelFactor(float factor) {
      this.refFresnelFactor = Math.max(0.0F, factor);
      return this;
   }

   public ZeroGlassStyle noShadow() {
      this.shadowExpand = 0.0F;
      this.shadowFactor = 0.0F;
      return this;
   }

   public ZeroGlassStyle simpleFrost() {

...
void main(){
    ...
    vColorTL = unpackColor4x8(inst.colors.x);
    vColorTR = unpackColor4x8(inst.colors.y);
    vColorBR = unpackColor4x8(inst.colors.z);
    vColorBL = unpackColor4x8(inst.colors.w);
    vRadii = inst.radii;
    vFlags = inst.flags;
    vClip = inst.clip;

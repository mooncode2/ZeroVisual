#version 450 core
layout(location = 0) in vec2 vLocalPx;
layout(location = 1) in vec2 vSize;
layout(location = 2) flat in vec4 vColorTL;
layout(location = 3) flat in vec4 vColorTR;
layout(location = 4) flat in vec4 vColorBR;
layout(location = 5) flat in vec4 vColorBL;
layout(location = 6) flat in vec4 vRadii;
layout(location = 7) flat in uint vFlags;
layout(location = 8) flat in ivec4 vClip;
layout(location = 9) flat in vec4 vClipRadii;
layout(location = 10) in vec2 vUV;
layout(location = 11) flat in vec2 vUvScale;
layout(location = 12) flat in vec2 vUvOffset;
layout(location = 13) flat in int vTexSlot;
layout(location = 14) in vec2 vPosPx;
